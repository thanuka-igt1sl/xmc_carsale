...
interface Fields {
  ...
  link_3: Field<string>;
  link_4: Field<string>;
  linkText_1: Field<string>;
  linkText_2: Field<string>;
  linkText_3: Field<string>;
  linkText_4: Field<string>; 
}
type HomePageLinksProps = {
  params: { [key: string]: string };
  fields: Fields;
};
export const Default = (props: HomePageLinksProps): React.ReactElement => {
  ...
  return (
    <div className={`container-default component ${styles}`}>
      ...
      <div className="grid gap-8 lg:grid-cols-2">
            <a
              href={props.fields?.link_1?.value || "#"}
            ...
            <a
              href={props.fields?.link_2?.value || "#"}
              className="inline-flex justify-center items-center p-5 text-base font-medium text-gray-500 bg-gray-50 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white"
            >
              <svg
                className="mr-3 w-5 h-5"
            ...
            <a
              href={props.fields?.link_3?.value || "#"}
              className="inline-flex justify-center items-center p-5 text-base font-medium text-gray-500 bg-gray-50 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white"
            >
              <svg
                className="mr-3 w-5 h-5"
            ...
            <a
              href={props.fields?.link_4?.value || "#"}
              className="inline-flex justify-center items-center p-5 text-base font-medium text-gray-500 bg-gray-50 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white"
            >
              <svg
                className="mr-3 w-5 h-5"
